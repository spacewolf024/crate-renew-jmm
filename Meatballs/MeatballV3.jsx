...
class MeatballV3 extends Component {
  ...
  constructor(...args) {
   this.setCategories = this.setCategories.bind(this);
    ...
    this.state.meatballArr.splice(1, 0, <svg className="meatballs"><path d='M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z'></path></svg>);
  }
